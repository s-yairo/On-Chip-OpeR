"""PDF generation for the built-in experiment condition advisor."""
...
def build_pdf(
    *,
    ...
    if not REPORTLAB_AVAILABLE:
        raise RuntimeError("PDF生成にはreportlabが必要です。")
    ...
    story = [
        ...
        Paragraph(
            escape(
                f"ナビゲーション：{navigation_version} ／ 実験条件検討：{feature_version} ／ "
